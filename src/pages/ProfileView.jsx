    ...
    <div className="p-6 bg-navy-dark min-h-screen text-white">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-slate-400 mt-1">
          Manage your security settings, identity profile credentials, and
          role-specific platform configurations.
        </p>
      </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-gray-dark border border-slate-800 rounded-3xl p-6 shadow-xl flex flex-col items-center text-center">
            ...
            <p className="text-xs text-slate-400 leading-normal">
              Account verification status is live. This authorization tier
              dictates dashboard console actions.
            </p>
          </div>
          ...
          <div className="bg-navy-deep/40 border border-slate-800/60 border-dashed rounded-3xl p-6 text-center text-slate-500 text-xs">
            {user?.role === 'washer' ? (
              <p>
                Washer verification credentials and payout stats will mount
                here.
              </p>
            ) : (
