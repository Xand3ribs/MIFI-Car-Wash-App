  ...
  return (
    <div className="flex flex-col gap-8 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                />
                {loading && (
                  <div className="w-4 h-4 border-2 border-blue-action/40 border-t-blue-action
              ...
              {suggestions.length > 0 && (
                <div className="absolute z-50 w-full mt-2 bg-gray-dark border border-border-dark
                  ...
                  <ul>
                    {suggestions.map((item, idx) => (
                      ...
                      >
                        <MapPin size={14} className="text-blue-action shrink-0 mt-0.5" />
                        <div>
                          <span className="block font-semibold text-sm">{item.display_place}</span>
                          <span className="block text-xs text-white/40">{item.display_address}</span>
                        </div>
                      </li>
                    ))}
                  </ul>
        ...
        {/* ── Right: Leaflet map ────────────────────────────────────────── */}
        <div className="relative z-10 w-full h-[420px] lg:h-auto rounded-3xl overflow-hidden
