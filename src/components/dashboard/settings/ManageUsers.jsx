...
const INITIAL_CUSTOMERS = [
  { id: 'USR-892', name: 'Chioma Adebayo', email: 'chioma@adebayo.co', phone: '+234 802 111 2222', tier: 'Premium', status: 'Active' },
  { id: 'USR-415', name: 'Tunde Bakare', email: 'tbakare@outlook.com', phone: '+234 815 333 4444', tier: 'Pay-As-You-Go', status: 'Active' },
  { id: 'USR-612', name: 'Funmi Olowu', email: 'funmi.olowu@gmail.com', phone: '+234 809 555 6666', tier: 'None', status: 'Suspended' },
];
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="border-b border-slate-800 pb-4">
        ...
        <p className="text-xs text-slate-500">Audit user base profiles, active subscription configurations, and tier credentials.</p>
      </div>
