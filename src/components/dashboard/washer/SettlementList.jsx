          ...
          payouts.map((payout) => (
            ...
            >
              <div className="flex justify-between items-center">
                <span className="font-mono text-xs font-bold text-blue-action">{payout.id}</span>
              ...
              <div className="flex justify-between items-end">
                ...
                <div className="text-base font-black text-slate-100">{payout.amount}</div>
              </div>
            </div>
          ))
        ) : (
            ...
            {payouts.length > 0 ? (
              payouts.map((payout) => (
                ...
                >
                  ...
                  <td className="py-4 font-black text-slate-100">{payout.amount}</td>
              ...
              <tr>
                <td colSpan="4" className="py-10 text-center text-xs text-slate-500 uppercase tracking-widest font-black">
