      ...
      <div className="bg-navy-deep border-t sm:border border-slate-800 rounded-t-3xl sm:rounded-3xl w-full max-w-md shadow-2xl overflow-hidden animate-in slide-in-from-bottom sm:zoom-in-95 duration-200">
        ...
        <div className="p-5 md:p-6 space-y-5 md:space-y-6">
          <div className="text-center py-4 bg-navy-dark/30 border border-slate-800/60 rounded-2xl">
            <span className="text-[10px] uppercase tracking-wider font-black text-slate-400">Net Settled Amount</span>
            <div className="text-2xl md:text-3xl font-black text-emerald-400 mt-0.5">{payout.amount}</div>
          ...
          <div className="grid grid-cols-2 gap-4 text-[11px] border-b border-slate-800/50 pb-4">
            <div>
              <span className="text-slate-500 block font-bold uppercase tracking-wide">Reference ID</span>
              <span className="text-slate-200 font-mono text-xs mt-0.5 block">{payout.id}</span>
            </div>
            <div>
              <span className="text-slate-500 block font-bold uppercase tracking-wide">Payment Date</span>
              <span className="text-slate-200 text-xs mt-0.5 block">{payout.date}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 bg-navy-dark/40 p-3.5 rounded-xl text-xs md:text-sm border border-slate-800/40">
            ...
            <div>
              <span className="text-[10px] text-slate-500 block font-bold uppercase">Destination Account</span>
