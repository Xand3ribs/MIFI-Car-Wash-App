...
export default function MetricCard({ label, value, subtext, icon: Icon, color }) {
  return (
    <div className="bg-navy-deep border border-slate-800 p-5 md:p-6 rounded-2xl shadow-md flex justify-between items-start">
      <div>
        ...
        <div className="text-xl md:text-2xl font-black text-slate-100">{value}</div>
        <span className="text-[11px] text-slate-400 mt-1 block font-medium">{subtext}</span>
      </div>
