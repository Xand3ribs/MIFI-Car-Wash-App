    ...
    <div className="flex-1 bg-gray-dark border border-border-dark rounded-3xl p-5 shadow-xl flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between border-b border-slate-800/80 pb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="font-black text-sm text-slate-100 mt-0.5">
              {planName}
            </p>
          </div>
        </div>
      ...
      <div>
        <div className="flex justify-between items-end text-xs font-bold mb-1.5">
          ...
          <span className="text-slate-200">
            {totalWashes - washesUsed} of {totalWashes} left
          </span>
        </div>
      ...
      <div className="bg-navy-deep/30 rounded-xl p-3 border border-slate-800 text-[11px] text-slate-400 flex flex-col gap-1.5">
        <p className="flex items-center gap-1.5">
          <span className="text-blue-action">✓</span> Priority weekend
          scheduling slot locks
        </p>
        <p className="flex items-center gap-1.5">
          <span className="text-blue-action">✓</span> Free interior scent bomb
          add-ons
        </p>
      </div>
      ...
      <Link
        ...
        className="text-center text-xs text-blue-action font-bold hover:underline py-1 mt-1 block"
      >
